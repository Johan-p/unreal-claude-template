...
Source of truth: `Engine/Source/Runtime/Engine/Classes/GameFramework/Actor.h` — the class-level Doxygen block documents the authoritative order of initialization virtual functions.
