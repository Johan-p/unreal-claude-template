...
public:
    ...
    void ReceiveDamageEvent(float Amount, AActor* Instigator);
};
...
class AMyCharacter : public ACharacter, public IDamageable
{
    GENERATED_BODY()
public:
    virtual void ReceiveDamageEvent_Implementation(float Amount, AActor* Instigator) override;
};

// Checking/casting via interface
if (SomeActor->Implements<UDamageable>())
{
    IDamageable::Execute_ReceiveDamageEvent(SomeActor, 25.f, this);
}
```
