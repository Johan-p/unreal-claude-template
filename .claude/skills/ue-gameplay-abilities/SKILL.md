...
description: "Use this skill when working with GAS, Gameplay Ability System, GameplayAbility, GameplayEffect, AttributeSet, GameplayTags, ability system, buffs, debuffs, cooldowns, attribute modification, ASC, AbilitySystemComponent, or GameplayCue. See references/ for detailed setup patterns, effect configuration, and ability task usage."
metadata:
  version: 1.0.0
---
...
UMyFireballAbility::UMyFireballAbility()
{
    ...
    // NonInstanced       - Deprecated since UE 5.5 (UE_DEPRECATED_FORGAME) — use InstancedPerActor
