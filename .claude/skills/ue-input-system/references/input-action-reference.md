...
|---|---|---|
| `DefaultKeyMappings.Mappings` | `TArray<FEnhancedActionKeyMapping>` | Default key-to-action bindings — current API (the legacy flat `Mappings` property is the deprecated one; read via `GetMappings()`) |
