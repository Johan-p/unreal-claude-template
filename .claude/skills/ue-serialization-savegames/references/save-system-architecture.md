...
private:
    ...
    void RunMigrations(UMyGameSaveGame* Save);
...
void AMyPlayerController::LoadPlayerData()
{
    ...
    bool bScheduled = ULocalPlayerSaveGame::AsyncLoadOrCreateSaveGameForLocalPlayer(
        ...
        GetLocalPlayer(), // const ULocalPlayer* — the native-delegate overload takes a
                          // ULocalPlayer; the APlayerController overload takes the
                          // DYNAMIC delegate (FOnLocalPlayerSaveGameLoaded) instead
        TEXT("PlayerData"),
