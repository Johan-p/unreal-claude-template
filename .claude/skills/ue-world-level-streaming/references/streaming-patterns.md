...
```cpp
// MyGameMode.h
// bUseSeamlessTravel = true; in the constructor — inherited from AGameModeBase, do not redeclare
...
// ServerZoneSubsystem.h — GetStatId() is pure virtual; omit it and the class stays abstract
UCLASS()
class UServerZoneSubsystem : public UTickableWorldSubsystem
{
    GENERATED_BODY()
public:
    virtual void Tick(float DeltaTime) override;
    virtual TStatId GetStatId() const override { RETURN_QUICK_DECLARE_CYCLE_STAT(UServerZoneSubsystem, STATGROUP_Tickables); }
};

// ServerZoneSubsystem.cpp
